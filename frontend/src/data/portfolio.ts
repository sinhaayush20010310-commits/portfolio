...
export const projects = [
  ...
  },
  {
    ...
    description: "A modern, responsive developer portfolio showcasing projects, experience, and skills, with an integrated resume viewer.",
    longDescription: "A personal portfolio website built to showcase professional experience, projects, and technical skills, featuring a clean responsive design, smooth animations, and an embedded resume for quick reference by recruiters.",
    image: "/projects/portfolio.png",
    images: ["/projects/portfolio-1.png"],
    liveUrl: "https://portfolio-ruby-one-n717j8qaek.vercel.app/",
    githubUrl: "https://github.com/sinhaayush20010310-commits",
    featured: true,
    category: "Web App",
    tech: ["React", "TypeScript", "Node.js", "Tailwind CSS"],
    stats: { deployment: "Vercel", responsive: "100%", uptime: "99.9%" },
    features: [
